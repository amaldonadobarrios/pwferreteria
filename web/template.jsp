...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Sistema Web Ferreteria</title>
    ...
    <body class="no-skin">
        ...
        <%@include file="dinamico/header.jspf" %>
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <%@include file="dinamico/menu.jspf" %>
        ...
        <!--
            ...
            <%@include file="dinamico/footer.jspf" %>
...
<![endif]-->
        ...
        <script src="assets/jss/customTable.js"></script>
        ...
        <!-- inline scripts related to this page            MALDONADO-->
          <script src="assets/js/dirtexto.js"></script>
