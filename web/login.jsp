<%-- 
    Document   : template
    Created on : 23/05/2017, 06:14:19 PM
    Author     : FARID
--%>
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">SISTEMA WEB</span>
                            <!--        <span class="white" id="id-text2">PNP</span> -->
                                </h1>
                             <!--      <h4 class="blue" id="id-company-text">&copy; Policia Nacional del Peru</h4>-->
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger">
                                                ...
                                                Gestion de Ventas, Compras, Producción  e Inventario
                                            </h4>
                                            ...
                                            <div alight="center" style="align-items: center; text-align: center; align-content: center;"><h4> ${msg}</h4> </div> 
                                        </div><!-- /.widget-main -->
